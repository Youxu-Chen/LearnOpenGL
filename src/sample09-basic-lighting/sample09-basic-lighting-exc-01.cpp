...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample09-basic-lighting-02-cube.vs", "./shaders/sample09-basic-lighting-02-cube.fs");    
        m_lightShader = Shader("./shaders/sample09-basic-lighting-02-light.vs", "./shaders/sample09-basic-lighting-02-light.fs");    
