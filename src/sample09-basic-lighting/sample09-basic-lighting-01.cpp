...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample09-basic-lighting-01-cube.vs", "./shaders/sample09-basic-lighting-01-cube.fs");    
        m_lightShader = Shader("./shaders/sample09-basic-lighting-01-light.vs", "./shaders/sample09-basic-lighting-01-light.fs");    
