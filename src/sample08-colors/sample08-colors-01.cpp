...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample08-colors-01-cube.vs", "./shaders/sample08-colors-01-cube.fs");    
        m_lightShader = Shader("./shaders/sample08-colors-01-light.vs", "./shaders/sample08-colors-01-light.fs");    
