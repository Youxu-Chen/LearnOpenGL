...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        shader = Shader("./shaders/sample13-framebuffers.vs", "./shaders/sample13-framebuffers.fs");    
        screenShader = Shader("./shaders/sample13-framebuffers_screen.vs", "./shaders/sample13-framebuffers_screen.fs");    
        ...
        cubeTexture = loadTexture("./images/container.jpg");
