...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample11-lighting-maps-02-cube.vs", "./shaders/sample11-lighting-maps-02-cube.fs");    
        m_lightShader = Shader("./shaders/sample11-lighting-maps-02-light.vs", "./shaders/sample11-lighting-maps-02-light.fs");    
