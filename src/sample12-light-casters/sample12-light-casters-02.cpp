...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample12-light-casters-02-cube.vs", "./shaders/sample12-light-casters-02-cube.fs");    
        m_lightShader = Shader("./shaders/sample12-light-casters-02-light.vs", "./shaders/sample12-light-casters-02-light.fs");    

        stbi_set_flip_vertically_on_load(true);

        // create texture object
        m_texture1 = loadTexture("./images/container2.png");
        m_texture2 = loadTexture("./images/container2_specular.png");
        m_shader.use();
...
private:
    ...
    unsigned int m_texture1;    // diffuseMap
    unsigned int m_texture2;    // specularMap
