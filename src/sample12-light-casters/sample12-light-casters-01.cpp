...
class MyColor : public Framework {
    void Startup() {
        ...
        // cube shader
        m_shader = Shader("./shaders/sample12-light-casters-01-cube.vs", "./shaders/sample12-light-casters-01-cube.fs");    
        m_lightShader = Shader("./shaders/sample12-light-casters-01-light.vs", "./shaders/sample12-light-casters-01-light.fs");    
