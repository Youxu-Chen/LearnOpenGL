...
class MyColor : public Framework {
    ...
    void Render() {
        ...
        m_shader.setVec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
        m_shader.setFloat("material.shininess", 32.0f);
        m_shader.setVec3("light.ambient",  1.0f, 1.0f, 1.0f);
        m_shader.setVec3("light.diffuse",  1.0f, 1.0f, 1.0f); // 将光照调暗了一些以搭配场景
